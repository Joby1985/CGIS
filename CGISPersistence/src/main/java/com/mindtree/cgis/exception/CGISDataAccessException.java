package com.mindtree.cgis.exception;
...
public class CGISDataAccessException extends DataAccessException {
	
	/**
	 * Constructor for SynergyDataAccessException.
	 * @param msg the detail message
	 */
	public CGISDataAccessException(String msg) {
		super(msg);
	}
	 ...
	 */
	public CGISDataAccessException(String msg, Throwable cause) {
		super(msg, cause);
	}
